// Sample AI-generated content for community pages
...
export const reviews = [
  ...
  },
  {
    ...
    date: "May 18, 2025",
    verified: true,
    content: "Great platform for discovering AI tools. The recommendation engine is spot-on. Only wish there were more tools in the creative category.",
  },
  {
    name: "Emma Watson",
    rating: 5,
...
export const forumCategories = [
  {
    ...
    description: "Discuss and share recommendations for different AI tools and use cases",
    topicCount: 156,
    lastPost: {
  ...
  },
  {
    ...
    description: "Share your AI workflow setups and get feedback from the community",
    topicCount: 89,
    lastPost: {
  ...
  },
  {
    ...
    description: "Compare different AI tools and discuss their pros and cons",
    topicCount: 234,
    lastPost: {
