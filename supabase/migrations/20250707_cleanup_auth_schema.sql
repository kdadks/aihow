-- =====================================================
-- COMPREHENSIVE AUTHENTICATION SCHEMA CLEANUP
-- =====================================================
-- This migration resolves table redundancy and conflicts
-- Date: 2025-07-07
...
-- ==================================================
-- SECTION 2: DROP REDUNDANT TABLES
-- ==================================================

-- Drop redundant tables and views that are causing conflicts
...
-- Drop the conflicting user_roles table (we'll recreate it properly)
DROP TABLE IF EXISTS public.user_roles CASCADE;

-- ==================================================
-- SECTION 3: RECREATE CLEAN SCHEMA
-- ==================================================
...
-- Restore from role assignments backup if needed
INSERT INTO public.user_roles (user_id, role_id, created_at)
SELECT DISTINCT user_id, role_id, NOW()
...
DROP TABLE IF EXISTS temp_user_role_backup;
...
DO $$
BEGIN
    RAISE NOTICE 'Authentication schema cleanup completed successfully!';
    RAISE NOTICE 'Redundant tables removed: user_profiles, users, admin_users, admin_sessions, user_role_assignments';
    RAISE NOTICE 'Simplified schema now uses: profiles, roles, permissions, user_roles, role_permissions';
    RAISE NOTICE 'Helper functions created for role and permission checking';
END $$;