...
-- Step 3: Verify the email update
SELECT 
    'EMAIL UPDATE RESULT:' as info,
    CASE 
        WHEN ROW_COUNT > 0 THEN '✅ Email and password updated successfully'
        ELSE '❌ No user found with that UUID'
